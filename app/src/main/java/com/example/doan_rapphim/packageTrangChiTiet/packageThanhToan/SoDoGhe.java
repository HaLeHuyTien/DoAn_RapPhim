...
public class SoDoGhe extends AppCompatActivity {
 ...
 private ImageView imgTenHinh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTenPhim.setText(ThongTinVe.tenPhim);
        txtSuatChieu.setText(ThongTinVe.suatChieu);
        int ResiD = this.getResources().getIdentifier(ThongTinVe.tenHinh,"drawable",this.getPackageName());
